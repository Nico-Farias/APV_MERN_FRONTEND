            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className=" my-5">
                        ...
                        <input className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="text" placeholder="Tu Nombre" value={nombre}
                    ...
                    <div className=" my-5">
                        ...
                        <input className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="email" placeholder="Email de Registro" value={email}
                    ...
                    <div className=" my-5">
                        ...
                        <input className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="password" placeholder="Tu Password" value={repetirPassword} onChange={e => setRepetirPassword(e.target.value)} />
                ...
                <nav className='mt-10 lg:flex lg:justify-between'>
                    ...
                    <Link className='block text-center my-5 text-gray-500' to="/">Ya tienen una cuenta? Inicia Sesion</Link>
